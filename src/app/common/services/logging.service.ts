...
export class LoggingService {
  ...
  debug(message: string, url: string): any   {
    const log: Log = {
      message,
  ...
  errorNoUser(error: any, url: string): any {
    const log: Log = {
  ...
  httperror(error: any, url: string): any {
    const log: Log = {
      message: error.error,
      user: this.currentUser,
      // datetime: this.datePipe.transform( new Date(), 'dd-MM-yyyy HH:mm:ss'),
  ...
  error(error: any, url: string): any {
    const log: Log = {
      message: error.error,
      user: this.currentUser,
      // datetime: this.datePipe.transform( new Date(), 'dd-MM-yyyy HH:mm:ss'),
  ...
  warn(message: string, url: string): any  {
    const log: Log = {
      message,
      user: this.currentUser,
      // datetime: this.datePipe.transform( new Date(), 'dd-MM-yyyy HH:mm:ss'),
  ...
  info(message: string, url: string): any {
    const log: Log = {
      message,
      user: this.currentUser,
  ...
  // createLogStatement(level, message): any {
  //   const SEPARATOR = '';
